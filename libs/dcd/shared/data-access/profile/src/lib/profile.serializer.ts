...
function getCharacterRecords(p: any, profileRecords: any) {
...
function getCharacterProgressions(data: any, progressionHashes: any) {
  const characterProgressions = {};
  if (data) {
    for (const [key, value] of Object.entries(data)) {
      const progressions = {};
      progressionHashes.forEach((ph: any) => {
...
function getProfileRecords(data: any, profileRecordHashes: number[] | string[]) {
  let profileRecords = {};
  if (data) {
    const progressions = {};
...
export function getProfileItems(data: any, itemHashes: number[] | string[]) {
  let profileRecords = {};
  if (data) {
    const progressions = {};
...
function getProfileMetrics(data: any, profileRecordHashes: number[]) {
  let profileRecords = {};
  if (data) {
    const progressions = {};
    profileRecordHashes.forEach((ph) => {
...
function getProgressionValues(prog: any) {
  return {
