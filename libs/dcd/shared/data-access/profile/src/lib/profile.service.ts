...
export class ProfileService {
  ...
  protected getProfileFromAPI(membershipType: number | string, membershipId: string | number) {
    const url = `https://www.bungie.net/Platform/Destiny2/${membershipType}/Profile/${membershipId}/?components=${this.profileComponents.join(
      ','
    )}`;
